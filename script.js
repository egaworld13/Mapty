...
class App {
  ...
  //* its a problem
  //*POSITION
  //? In regular functions 'this' keyword is undefined.
  //? binding this keyword to function will point to curr obj.
  ...
  _showForm(mapE) {
    ...
    //? add cursors to the selected input field
    inputDistance.focus();
  }
  _hideForm() {
    //Empty inputs
  ...
  //?SWITCHING BETWEEN CYCLING AND RUNNING!
  _toggleElevationField() {
    inputElevation.closest('.form__row').classList.toggle('form__row--hidden');
    inputCadence.closest('.form__row').classList.toggle('form__row--hidden');
  }

  //*DISPLAYING WORKOUT ON MAP.
  _newWorkout(e) {
